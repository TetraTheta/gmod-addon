...
hook.Add("PopulateToolMenu", "SCKillfeedSettingsMenu", function()
  ...
  spawnmenu.AddToolMenuOption("Utilities", "SC Killfeed", "sc_killfeed_settings", "Settings", nil, nil, function(panel)
    ...
    menu_lib.AddClientCheckBox(panel, "Enable Custom Killfeed", "sc_killfeed_enabled", "Enable or disable the customized killfeed system.")
    menu_lib.AddClientCheckBox(panel, "Show Headshot Icons", "sc_killfeed_show_headshot", "Show headshot icons next to weapon icons on headshot kills.")
