...
SWEP.Instructions = "SMG1 Clone"
SWEP.PrintName = "SMG2"
SWEP.Purpose = "SMG1 Clone"
SWEP.Slot = 2
SWEP.SlotPos = 0
SWEP.Spawnable = true
SWEP.UseHands = true
...
SWEP.Primary.CFG_Damage = ConVarExists("sk_plr_dmg_smg1") and GetConVar("sk_plr_dmg_smg1"):GetInt() or 4
SWEP.Primary.CFG_Delay = 0.075
SWEP.Primary.CFG_Force = 4
SWEP.Primary.CFG_MaxVerticalKick = 1
SWEP.Primary.CFG_Sound = "Weapon_SMG1.Single"
SWEP.Primary.CFG_SoundNPC = "Weapon_SMG1.NPC_Single"
SWEP.Primary.CFG_Spread = Vector(0.005, 0.005, 0)
SWEP.Primary.CFG_NPCSpread = Vector(0.08716, 0.08716, 0) -- VECTOR_CONE_5DEGREES in Source SDK 2013.
-- SWEP Secondary Fire
...
SWEP.Secondary.CFG_Sound = "Weapon_SMG1.Double"
--
...
if CLIENT then
  local SMG1_SELECT_ICON_FONT = "weapon_smg2_smg1_select_icon"
