...
--
_CreateConVar("scaw_mp5_default", "Default secondary fire mode of SC Admin MP5", "1", 1, 5)
_CreateConVar("scaw_mp5sd_default", "Default secondary fire mode of SC Admin MP5SD", "1", 1, 5)
...
_CreateConVar("scaw_pistol_default", "Default secondary fire mode of SC Admin Pistol", "1", 1, 5)
